...
//		}
		...
		//how to print only name of hibernate 
//		List<String> accountHolderNames=session.createQuery("select a.name from Account a",String.class).getResultList();
//
//		//need to just print it
//		for (String name : accountHolderNames) {
...
//		}
		 ...
		 * .createQuery("select new com.crud.AccountData( a.name, a.balance) from Account a"
